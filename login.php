  ...
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_right">
      <ul class="nospace inline pushright">
        <li><i class="fa fa-phone"></i> +2347063691696</li>
        <li><i class="fa fa-envelope-o"></i> abuchicollins449@gmail.com </li>
      </ul>
    </div>
    <!-- ################################################################################################ -->
  </div>
...
<div class="wrapper row1">
  <header id="header" class="hoc clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.html">eVoting</a></h1>
    </div>
    <!-- ################################################################################################ -->
    <nav id="mainav" class="fl_right">
      <ul class="clear">
        <li class="active"><a href="cpanel.php">Home</a></li>
...
<tr>
<form name="form1" method="post" action="authentication.php" onSubmit="return loginValidate(this)">
<td>
  ...
  <footer id="footer" class="hoc clear"> 
    ...
    <div class="one_third first">
      ...
      <ul class="nospace linklist contact">
        <li><i class="fa fa-map-marker"></i>
          ...
          <p>
          Name        : Abuchi Nwajagu Collins <br>
          University  : Nile University<br>
          Batch       : 2019 <br>
          Dept        : SEN <br>
          </p>
          </address>
    ...
    <div class="one_third">
      ...
      <ul class="nospace linklist contact">
        ...
        <li><i class="fa fa-phone"></i> +2347063691696<br>
          +2347063691696</li>
